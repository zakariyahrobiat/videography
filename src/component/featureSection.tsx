  ...
  const learnings = [
    {
      ...
      text: "Shoot clean, professional videos with your smartphone",
      Icon: FaVideo,
    },

    {
      heading: "Smartphone Video Editing",
      text: "Edit videos and Create content that stands out online",
      Icon: FaEdit,
    },
    {
      heading: "Monetization & Opportunities",
      text: "Save money on hiring videographers or editors.",
      Icon: FaMoneyBill,
    },
  ];
